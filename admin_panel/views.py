...
class ConsultingListAdminPanelView(ListCreateAPIView):
    ...
    def get_queryset(self):
        ...
        if search:
            pass
            q = q.filter(Q(first_name__icontains=search) | Q(last_name__icontains=search) | Q(phone__icontains=search) | Q(province__icontains=search) | Q(city__icontains=search) | Q(land_product__icontains=search))
