...
class Request(models.Model):
    ...
    phone = models.CharField(_('تلفن'), validators=[phone_validator], max_length=12, db_index=True)
    ...
    created_at = models.DateTimeField(auto_now_add=True, verbose_name=_('ایجاد شده در'), db_index=True)
